...
function viewModel(params) {
        ...
        this.resourceData.subscribe(function(val){
            ...
            if (!val.resource['Status']) {
                ...
                window.fetch(generateArchesURL('arches:api_tiles')(uuid.generate()), {
                    method: 'POST',
                    credentials: 'include',
        ...
        this.relatedResources.subscribe(function(val){
            ...
            if (digitalResource) {
                self.relatedFile = {'name': 'Related Files', 'value': digitalResource.displayname, 'link': `${generateArchesURL('arches:resource')}\\${digitalResource.resourceinstanceid}`};
            } else {
