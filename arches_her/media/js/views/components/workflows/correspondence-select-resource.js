...
function viewModel(params) {
        ...
        this.retrieveFile = function(tile) { //correspondence tile of consultation resource
            ...
            $.ajax({ //save the file and create digital resource
                type: "POST",
                url: generateArchesURL('arches:root') + 'filetemplate',
                data: {
            ...
            .done(function(data){ //getting digital object resource
                ...
                $.ajax({ //get consultation name
                    url: generateArchesURL('arches:api_resources')(ko.unwrap(self.tile().resourceinstance_id)),
                    type: 'GET',
                    dataType: 'json',
                    data: {
                        'format': 'json'
                    ...
                    $.ajax({ //saving the digital resource name
                        url: generateArchesURL('arches:api_tiles')(uuid.generate()),
                        type: 'POST',
                        dataType: 'json',
                        data: {
