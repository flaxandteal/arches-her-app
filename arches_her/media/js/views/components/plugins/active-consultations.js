...
export default ko.components.register('active-consultations',  {
        viewModel: function(params) {
            var self = this;
            this.resourceEditorURL = generateArchesURL('arches:resource_editor');
            this.moment = moment;
            ...
            this.getConsultations = function() {
                ...
                $.ajax({
                    type: "GET",
                    url: generateArchesURL('arches:root') + 'activeconsultations',
                    data: {
                        "page": self.page(),
                ...
                ajax: {
                    ...
                    dataSrc: function(data) {
                        ...
                        consultations.forEach( function(consultation) {
                            var link= generateArchesURL('arches:resource')+'/'+consultation["resourceinstanceid"];
                            results.push([
